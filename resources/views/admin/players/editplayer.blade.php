...
<div class="content">
    <h2 class="text-xl font-bold truncate text-primary mt-8">
        Edit Player Details <a class="btn btn-sm btn-pending-soft w-24 float-right" href="{{route('admin/allplayers')}}">Go Back</a>
    </h2>
    @foreach($users as $users)
    <form action="{{ route('admin/updateplayer') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <input type="hidden" name="hidden_userUID" value="{{$users->user_id}}">
        <hr class="my-4">
            ...
            <div class="col-span-6 md:col-span-6 2xl:col-span-6">
                <div class="intro-x">
                    <div class="box px-5 py-3 mb-0 flex items-center zoom-in">
                        ...
                        <input type="text" id="first_name" name="first_name" placeholder="Enter First Name" class="form-control"  value="{{old('first_name',$users->first_name)}}" required>
                    </div>
                    </div>
                </div>
            <div class="col-span-6 md:col-span-6 2xl:col-span-6">
                <div class="intro-x">
                    <div class="box px-5 py-3 mb-0 flex items-center zoom-in">
                        ...
                        <input type="text" id="last_name" name="last_name" placeholder="Enter Last Name" class="form-control"  value="{{old('last_name', $users->last_name)}}" required>
                    </div>
                </div>
            </div>
            ...
            <div class="col-span-6 md:col-span-6 2xl:col-span-6">
                <div class="intro-x">
                    <div class="box px-5 py-3 mb-0 flex items-center zoom-in">
                        ...
                        @endphp
                        <input type="date" id="dob" name="dob" placeholder="Enter Date of Birth" class="form-control" required value="{{$dobdate}}" >
                    </div>
                </div>
            </div>
            <div class="col-span-6 md:col-span-6 2xl:col-span-6">
                <div class="intro-x">
                    <div class="box px-5 py-3 mb-0 flex items-center zoom-in">
                        ...
                        <input type="text" id="gender" name="gender" placeholder="Enter Gender" class="form-control" required value="{{old('gender',$users->gender)}}" >
                    </div>
                </div>
            </div>
            <div class="col-span-6 md:col-span-6 2xl:col-span-6">
                <div class="intro-x">
                    <div class="box px-5 py-3 mb-0 flex items-center zoom-in">
                        ...
                        <input type="text" id="email" name="email" placeholder="Enter Email" class="form-control" required value="{{old('email',$users->email)}}" >
                    </div>
                </div>
            </div>
            <div class="col-span-6 md:col-span-6 2xl:col-span-6">
                <div class="intro-x">
                    <div class="box px-5 py-3 mb-0 flex items-center zoom-in">
                        ...
                        <input type="text" id="mobile" name="mobile" placeholder="Enter Mobile" class="form-control" required oninput="this.value = this.value.replace(/[^0-9]/g, '')" value="{{ old('mobile', $users->mobile) }}">
                    </div>
                </div>
            </div>
            <div class="col-span-6 md:col-span-6 2xl:col-span-6">
            ...
            <div class="col-span-6 md:col-span-6 2xl:col-span-6">
                <div class="intro-x">
                    <div class="box px-5 py-3 mb-0 flex items-center zoom-in">
                        ...
                        <input type="text" id="father_mobile" name="father_mobile" placeholder="Enter Father/Guardian Mobile Number" class="form-control" oninput="this.value = this.value.replace(/[^0-9]/g, '')" required value="{{old('father_mobile',$users->father_mobile)}}" >
                    </div>
                </div>
            </div>
            <div class="col-span-6 md:col-span-6 2xl:col-span-6">
                <div class="intro-x">
                    <div class="box px-5 py-3 mb-0 flex items-center zoom-in">
                        ...
                        <input type="text" id="aadhar" name="aadhar" placeholder="Enter Aadhar No" class="form-control" oninput="this.value = this.value.replace(/[^0-9]/g, '')" required value="{{old('aadhar',$users->aadhar)}}" >
                    </div>
                </div>
            </div>
        <div class="col-span-6 md:col-span-6 2xl:col-span-6">
            ...
            <div class="col-span-6 md:col-span-6 2xl:col-span-6">
                <div class="intro-x">
                    <div class="box px-5 py-3 mb-0 flex items-center zoom-in">
                        ...
                        <input type="text" id="height" name="height" placeholder="Enter Height" class="form-control" oninput="this.value = this.value.replace(/[^0-9]/g, '')"  value="{{old('height',$users->height)}}" >
                    </div>
                </div>
            </div>
            <div class="col-span-6 md:col-span-6 2xl:col-span-6">
                <div class="intro-x">
                    <div class="box px-5 py-3 mb-0 flex items-center zoom-in">
                        ...
                        <input type="text" id="weight" name="weight" placeholder="Enter Weight" class="form-control" oninput="this.value = this.value.replace(/[^0-9]/g, '')"  value="{{old('weight',$users->weight)}}" >
                    </div>
                </div>
            </div>
                ...
                <div class="intro-x">
                    <div class="box px-5 py-3 mb-0 flex items-center zoom-in">
                        <div class="text-start w-1/4">
                            ...
                            <select name="association" id="association" style="width: 100%; height: 40px;">
                                @php
                                    $association = \App\Models\MAssociation::where('id', $users->association)->first();
                                @endphp
                                @if ($association)
            ...
            <div class="col-span-6 md:col-span-6 2xl:col-span-6">
                <div class="intro-x">
                    <div class="box px-5 py-3 mb-0 flex items-center zoom-in">
                        ...
                        <input type="text" id="address" name="address" placeholder="Enter Address" class="form-control" required value="{{old('address',$users->address)}}" >
                    </div>
                    </div>
                </div>
            <div class="col-span-6 md:col-span-6 2xl:col-span-6">
            ...
            <div class="col-span-6 md:col-span-6 2xl:col-span-6">
                <div class="intro-x">
                    <div class="box px-5 py-3 mb-0 flex items-center zoom-in">
                        ...
                        <input type="text" id="caddress" name="caddress" placeholder="Enter Address" class="form-control" required value="{{old('caddress',$users->caddress)}}" >
                    </div>
                    </div>
                </div>
            <div class="col-span-6 md:col-span-6 2xl:col-span-6">
                <div class="intro-x">
                    <div class="box px-5 py-3 mb-0 flex items-center zoom-in">
                        ...
                        <input type="text" id="cpincode" name="cpincode" placeholder="Enter Pincode" class="form-control"oninput="this.value = this.value.replace(/[^0-9]/g, '')" required value="{{ old('cpincode',$users->cpincode)}}" >
                    </div>
                </div>
            </div>
            <div class="col-span-12">
            ...
            <div class="col-span-6 md:col-span-6 2xl:col-span-6">
                <div class="intro-x">
                    <div class="box px-5 py-3 mb-0 flex items-center zoom-in">
                        ...
                        @endphp
                        <select name="bank_name" id="bank_name" style="width: 100%; height: 40px;" >
            ...
            <div class="col-span-6 md:col-span-6 2xl:col-span-6">
                <div class="intro-x">
                    <div class="box px-5 py-3 mb-0 flex items-center zoom-in">
                        ...
                        <input type="text" id="bank_branch" name="bank_branch" placeholder="Enter Branch name" class="form-control"  value="{{old('bank_branch', $users->bank_branch)}}" >
                    </div>
                </div>
            </div>
            <div class="col-span-6 md:col-span-6 2xl:col-span-6">
                <div class="intro-x">
                    <div class="box px-5 py-3 mb-0 flex items-center zoom-in">
                        ...
                        <input type="text" id="bank_account" name="bank_account" placeholder="Enter Account number" class="form-control"  value="{{old('bank_account', $users->bank_account)}}" >
                    </div>
                </div>
            </div>
            <div class="col-span-6 md:col-span-6 2xl:col-span-6">
                <div class="intro-x">
                    <div class="box px-5 py-3 mb-0 flex items-center zoom-in">
                        ...
                        <input type="text" id="bank_ifsc" name="bank_ifsc" placeholder="Enter IFSC code" class="form-control"  value="{{old('bank_ifsc', $users->bank_ifsc)}}" >
                    </div>
                </div>
            </div>
            <div class="col-span-12">
            ...
            <div class="col-span-4 md:col-span-4 2xl:col-span-4">
                <div class="intro-x">
                    <div class="box px-5 py-3 mb-0 items-center zoom-in">
                        ...
                        <div class="mt-4">
                            <img width="100%" img alt="proof" class="rounded-md" onerror="this.src='https://developers.elementor.com/docs/assets/img/elementor-placeholder-image.png';"  src="{{ Storage::disk('s3')->url('IRFU/photo/'.old('photo',$users->photo)) }}" style="width: 200px; height: 200px; cursor: pointer;">
                        </div>
            ...
            <div class="col-span-4 md:col-span-4 2xl:col-span-4" >
                <div class="intro-x">
                    <div class="box px-5 py-3 mb-0 items-center zoom-in">
                        ...
                        <div class="mt-4">
                            <img width="100%" img alt="proof" class="rounded-md" onerror="this.src='https://developers.elementor.com/docs/assets/img/elementor-placeholder-image.png';" style="width: 200px;height: 200px;cursor: pointer;" src="{{ Storage::disk('s3')->url('IRFU/dob_proof/' . $users->dob_proof) }}" style="width: 200px; height: 200px; cursor: pointer;">
                        </div>
