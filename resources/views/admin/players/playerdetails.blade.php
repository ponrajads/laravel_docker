        ...
        <div class="col-span-12 md:col-span-6 2xl:col-span-12">
            <div class="intro-x">
                <div class="box px-5 py-3 mb-0 flex items-center zoom-in">
                    ...
                    <div class="text-slate-500 playervalue">{{ $user->associated_club }}</div>
                </div>
            </div>
        </div>
            ...
            <div class="intro-x">
                <div class="box px-5 py-3 mb-0 items-center zoom-in">
                    ...
                    <div class="mt-4">
                        ...
                        <img alt="proof" class="rounded-md" onerror="this.src='https://developers.elementor.com/docs/assets/img/elementor-placeholder-image.png';" src="{{ Storage::disk('s3')->url('IRFU/photo/' . $user->photo) }}"style="width: 200px; height: 200px; cursor: pointer;">

                    </div>
                    <div class="flex space-between mt-4">
                        <a href="{{ Storage::disk('s3')->url('IRFU/photo/' . $user->photo) }}" target="_blank" rel="noopener" class="btn btn-sm btn-linkedin w-24">
                            <i data-lucide="eye" class="w-3 h-3 mr-1"></i> View
                        </a>
                        <a href="{{ Storage::disk('s3')->url('IRFU/photo/' . $user->photo) }}" download class="btn btn-sm btn-linkedin w-24">
        ...
        <div class="col-span-12 md:col-span-4 2xl:col-span-12">
            <div class="intro-x">
                <div class="box px-5 py-3 mb-0 items-center zoom-in">
                    ...
                    <div class="mt-4">
                        <img alt="proof" class="rounded-md" onerror="this.src='https://developers.elementor.com/docs/assets/img/elementor-placeholder-image.png';" src="{{ Storage::disk('s3')->url('IRFU/dob_proof/' . $user->dob_proof) }}"style="width: 200px; height: 200px; cursor: pointer;">

                    </div>
                    <div class="flex space-between mt-4">
                        <a href="{{ Storage::disk('s3')->url('IRFU/dob_proof/' . $user->dob_proof) }}" target="_blank" rel="noopener" class="btn btn-sm btn-linkedin w-24">
                            <i data-lucide="eye" class="w-3 h-3 mr-1"></i> View
                        </a>
                        <a href="{{ Storage::disk('s3')->url('IRFU/dob_proof/' . $user->dob_proof) }}" download class="btn btn-sm btn-linkedin w-24">
                            <i data-lucide="download" class="w-3 h-3 mr-1"></i> Download
                        </a>
                    </div>
                </div>
        ...
        <div class="col-span-12 md:col-span-4 2xl:col-span-12">
            <div class="intro-x">
                <div class="box px-5 py-3 mb-0 items-center zoom-in">
                    ...
                    <div class="mt-4">
                        <img alt="proof" class="rounded-md" onerror="this.src='https://developers.elementor.com/docs/assets/img/elementor-placeholder-image.png';" src="{{ Storage::disk('s3')->url('IRFU/address_proof/' . $user->address_proof) }}"style="width: 200px; height: 200px; cursor: pointer;">

                    </div>
                    <div class="flex space-between mt-4">
                        <a href="{{ Storage::disk('s3')->url('IRFU/address_proof/' . $user->address_proof) }}" target="_blank" rel="noopener" class="btn btn-sm btn-linkedin w-24">
                            <i data-lucide="eye" class="w-3 h-3 mr-1"></i> View
                        </a>
                        <a href="{{ Storage::disk('s3')->url('IRFU/address_proof/' . $user->address_proof) }}" download class="btn btn-sm btn-linkedin w-24">
                            <i data-lucide="download" class="w-3 h-3 mr-1"></i> Download
                        </a>
                    </div>
                </div>
    ...
    <div id="icon-button" class="py-5">
        <div class="preview">
            <div class="flex flex-wrap justify-end">
                ...
                <a href="{{ url('generate-idcard/'.$user->user_id) }}" class="btn btn-primary w-32 mr-2 mb-2" > <i data-lucide="x-circle" class="w-4 h-4 mr-2"></i> Download IDCard </a>
                <a href="{{ route('admin/editplayerdetails', $user->user_id) }}" class="btn btn-instagram w-32 mr-2 mb-2"> <i data-lucide="pencil" class="w-4 h-4 mr-2"></i> Edit</a>
            ...
            <div class="modal-body p-0">
                <div class="p-5 text-center">
                    ...
                    <div class="text-slate-500 mt-2">
                        Do you really want to approve this player?
                        <br>
