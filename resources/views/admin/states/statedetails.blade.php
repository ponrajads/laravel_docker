...
<div class="content">
    <h2 class="text-xl font-bold truncate text-primary mt-8">
        State Details <a class="btn btn-sm btn-pending-soft w-24 float-right" href="{{route('admin/allassociations')}}">Go Back</a>
    </h2>
    <hr class="my-4">
        ...
        <div class="col-span-12 md:col-span-6 2xl:col-span-12">
            <div class="intro-x">
                <div class="box px-5 py-3 mb-0 flex items-center zoom-in">
                    ...
                    <?php $association = \App\Models\MAssociation::where('id',$user->association_id)->first();?>
            ...
            <div class="intro-x">
                <div class="box px-5 py-3 mb-0 items-center zoom-in">
                    ...
                    <div class="mt-4">
                        ...
                        <img alt="proof" class="rounded-md" onerror="this.src='https://developers.elementor.com/docs/assets/img/elementor-placeholder-image.png';" src="{{ Storage::disk('s3')->url('BFI/photo/' . $user->photo) }}">
        ...
        <div class="col-span-12 md:col-span-4 2xl:col-span-12">
            <div class="intro-x">
                <div class="box px-5 py-3 mb-0 items-center zoom-in">
                    ...
                    <div class="mt-4"> 
                        <img alt="proof" class="rounded-md" onerror="this.src='https://developers.elementor.com/docs/assets/img/elementor-placeholder-image.png';" src="{{ Storage::disk('s3')->url('BFI/dob_proof/' . $user->dob_proof) }}">
        ...
        <div class="col-span-12 md:col-span-4 2xl:col-span-12">
            <div class="intro-x">
                <div class="box px-5 py-3 mb-0 items-center zoom-in">
                    ...
                    <div class="mt-4">
                        <img alt="proof" class="rounded-md" onerror="this.src='https://developers.elementor.com/docs/assets/img/elementor-placeholder-image.png';" src="{{ Storage::disk('s3')->url('BFI/address_proof/' . $user->address_proof) }}">
                    ...
                    <div class="text-left mt-4">
                        ...
                        <div class="mt-2">
                            <select id="rejectReason" data-placeholder="Select the Reason" class="tom-select w-full">
                                ...
                                <option value="Address was mismatched / Wrong Address">Address was mismatched / Wrong Address</option>
