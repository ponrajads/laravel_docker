...
<div class="content">
    <h2 class="text-xl font-bold truncate text-primary mt-8">
        List of All Academy <a class="btn btn-sm btn-pending-soft w-24 float-right" href="dashboard.php">Back to Home</a>
        {{-- <a class="btn btn-sm btn-pending-soft w-24 float-right" href="">Upload Coaches</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; --}}
    </h2>
            ...
            <table class="table table-report -mt-2" id="players-table">
                <thead>
                    <tr>
                        ...
                        <th class="whitespace-nowrap">Academy Name</th>
                    ...
                    <tr class="intro-x">
                        ...
                        <td class="table-report__action">
                            <div class="flex justify-center items-center">
                                <a class="flex items-center mr-2 text-xs" href="{{route('admin/club', $players->user_id)}}"> <i data-lucide="eye" class="w-3 h-3 mr-1"></i> View </a>
                                <a href="#" class="flex items-center text-danger text-xs delete-btn" data-id="{{ $players->user_id }}"><i data-lucide="trash-2" class="w-3 h-3 mr-1"></i>Delete</a>
