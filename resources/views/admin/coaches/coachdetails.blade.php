...
<div class="content">
    <h2 class="text-xl font-bold truncate text-primary mt-8">
        Coach Details <a class="btn btn-sm btn-pending-soft w-24 float-right" href="{{route('admin/allplayers')}}">Go Back</a>
    </h2>
    <hr class="my-4">
        ...
        <div class="col-span-12 md:col-span-6 2xl:col-span-12">
            <div class="intro-x">
                <div class="box px-5 py-3 mb-0 flex items-center zoom-in">
                    ...
                    <div class="text-slate-500 playervalue">{{$user->pan}}</div>
                </div>
            </div>
        </div>
        <div class="col-span-12 md:col-span-6 2xl:col-span-12">
        ...
        <div class="col-span-12 md:col-span-6 2xl:col-span-12">
            ...
            <div class="intro-x">
                <div class="box px-5 py-3 mb-1 flex items-center zoom-in">
                    ...
                    <div class="text-slate-500 playervalue">{{$user->address1}}</div>
                </div>
            </div>
            <div class="intro-x">
                <div class="box px-5 py-3 mb-1 flex items-center zoom-in">
                    ...
                    <div class="text-slate-500 playervalue">{{$user->address2}}</div>
                </div>
            </div>
            <div class="intro-x">
                <div class="box px-5 py-3 mb-1 flex items-center zoom-in">
        ...
        <div class="col-span-12 md:col-span-6 2xl:col-span-12">
            <div class="intro-x">
                <div class="box px-5 py-3 mb-0 flex items-center zoom-in">
                    ...
                    <div class="text-slate-500 playervalue">{{$user->account_no}}</div>
                </div>
            </div>
        </div>
        <div class="col-span-12 md:col-span-6 2xl:col-span-12">
            <div class="intro-x">
                <div class="box px-5 py-3 mb-0 flex items-center zoom-in">
                    ...
                    <div class="text-slate-500 playervalue">{{$user->ifsc_code}}</div>
                </div>
            </div>
        </div>
        <div class="col-span-12">
        ...
        <div class="col-span-12 md:col-span-4 2xl:col-span-12">
            <div class="intro-x">
                <div class="box px-5 py-3 mb-0 items-center zoom-in">
                    ...
                    <div class="mt-4">
                        <img alt="proof" class="rounded-md" src="{{ Storage::disk('s3')->url('IRFU/dob_proof/' . $user->dob_proof) }}">
        ...
        <div class="col-span-12 md:col-span-4 2xl:col-span-12">
            <div class="intro-x">
                <div class="box px-5 py-3 mb-0 items-center zoom-in">
                    ...
                    <div class="mt-4">
                        <img alt="proof" class="rounded-md" src="{{ Storage::disk('s3')->url('IRFU/address_proof/' . $user->address_proof) }}">
...
<script>
     ...
     function approveUser(userId) {
        ...
        $.ajax({
            url: baseUrl + "/admin/coach/approve/" + userId,
            type: 'GET',
            success: function(response) {
                ...
                if(response.status == 'success'){
                 Swal.fire({
                    title: 'Success',
                    text: 'Coach has been approved successfully.',
                    icon: 'success',
    ...
    function rejectUser(userId) {
        ...
        // Make AJAX request
        $.ajax({
            url: baseUrl + "/admin/coach/reject/"+userId+"/"+selectedReason, // Replace with your actual route
            type: 'GET',
            success: function(response) {
                // Handle success response
                console.log(response);
                ...
                if(response.status == 'success'){
                 Swal.fire({
                    title: 'Success',
                    text: 'Coach has been rejected successfully.',
                    icon: 'success',
                    confirmButtonText: 'OK'
                }).then((result) => {
    // Check if the user clicked "OK"
...
<script>
    function blockUser(userId) {
        ...
        // Make AJAX request
        $.ajax({
            url: baseUrl + "/admin/coach/block/"+userId, // Replace with your actual route
            type: 'GET',
            success: function(response) {
                // Handle success response
                console.log(response);
                ...
                if(response.status == 'success'){
                 Swal.fire({
                    title: 'Success',
                    text: 'Coach has been blocked successfully.',
                    icon: 'success',
                    confirmButtonText: 'OK'
                }).then((result) => {
    // Check if the user clicked "OK"
