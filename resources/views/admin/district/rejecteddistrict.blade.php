...
<div class="content">
    <h2 class="text-xl font-bold truncate text-primary mt-8">
        List of Rejected Districts <a class="btn btn-sm btn-pending-soft w-24 float-right" href="{{route('admin/dashboard')}}">Back to Home</a>
    </h2>
            ...
            button.addEventListener('click', function (event) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = "{{ url('admin/state/delete') }}" + '/' + categoryId;
                    }
                });
            });
        });
