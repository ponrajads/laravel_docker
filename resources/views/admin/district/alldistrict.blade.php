...
<div class="content">
    <h2 class="text-xl font-bold truncate text-primary mt-8">
        List of All District <a class="btn btn-sm btn-pending-soft w-24 float-right" href="{{route('admin/dashboard')}}">Back to Home</a>&nbsp;&nbsp;
        <a class="btn btn-sm btn-pending-soft w-24 float-right" href="{{route('admin/uploadstates')}}">Upload States</a>
    </h2>
                    ...
                    <tr class="intro-x">
                        ...
                        <td class="table-report__action">
                            <div class="flex justify-center items-center">
                                <a class="flex items-center mr-2 text-xs" href="{{route('admin/district', $players->user_id)}}"> <i data-lucide="eye" class="w-3 h-3 mr-1"></i> View </a>
