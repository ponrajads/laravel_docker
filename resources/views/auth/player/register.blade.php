        ...
        <div class="block xl:grid grid-cols-12 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen col-span-12 md:col-span-4 lg:col-span-4">
                <a href="#" class="-intro-x flex items-center pt-5">
                    <!-- <img alt="Indian Rugby Logo" class="w-20" src="dist/images/logo/rugbylogo.png"> -->
                ...
                <div class="my-auto">
                    ...
                    <div class="-intro-x font-medium text-xl mt-10 text-white">
                        If you have an account already. <br><a href="{{ route('login') }}" class="underline text-warning">Login here!</a>
                    </div>
                </div>
            </div>
            <!-- END: Login Info -->
                                ...
                                <div class="pt-5">
                                        ...
                                        <div class="grid grid-cols-12 gap-4 mt-2">
                                            <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                                ...
                                                <input type="text"
                                                    ...
                                                    onkeypress="return ValidateAlpha(event)" maxlength="35" required>
                                            ...
                                            <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                                ...
                                                <input type="text"
                                                    ...
                                                    onkeypress="return ValidateAlpha(event)" maxlength="35" name="lastname"
                                                    value="{{ old('lastname') }}">
                                            ...
                                            <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                                <label for="certificate_name" class="form-label">Name on the
                                                    Certificate</label>
                                                <input type="text"
                                                    class="w-full form-control  shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                                                    placeholder="Enter your Certificate Name..."
                                                    onkeypress="return ValidateAlpha(event)" maxlength="35" name="certificate_name"
                                                    value="{{ old('certificate_name') }}">
                                                <span id="certificate_name-error" class="text-red-500"></span>
                                            ...
                                            <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                                ...
                                                <input type="email" onkeyup="checkEmailExist()" name="email"
                                                    class="w-full form-control shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                                                    placeholder="Enter your email address..." maxlength="50" id="email">
                                            ...
                                            <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                                ...
                                                <input type="email" name="re-email"
                                                    class="w-full form-control shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                                                    placeholder="Enter your email address..." maxlength="50" id="re-email">
                                            ...
                                            <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                                ...
                                                <input type="text" onkeypress="return onlyNumberKey(event)"
                                                    name="aadhar" minlength="12" maxlength="12"
                                                    class="w-full form-control shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                                                    placeholder="Enter your Aadhar card number..." id="aadhar">
                                        ...
                                        <div class="mb-5">
                                            <div class="grid grid-cols-12 gap-2 mt-0">
                                                <div class="col-span-12">
                                                    <h2 class="text-xl font-bold text-pending underline">Personal
                                                        Information</h2>
                                                </div>
                                                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                                    <label for="firstname" class="form-label">Height in cms</label>
                                                    <input type="text" onkeypress="return onlyNumberKey(event)"
                                                        name="height" maxlength="6" minlength="2"
                                                        class="w-full form-control  shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                                                        placeholder="Height in cms">
                                                </div>
                                                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                                    <label for="firstname" class="form-label">Weight in Kgs</label>
                                                    <input type="tel" onkeypress="return onlyNumberKey(event)"
                                                        name="weight" maxlength="6" minlength="2"
                                                        class="w-full form-control  shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                                                        placeholder="Weight in Kgs">
                                                </div>
                                                <div class="col-span-12">
                                                    <h2 class="text-xl font-bold text-pending underline">Parent Information
                                                    </h2>
                                                </div>
                                                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                                    <label for="firstname" class="form-label">Father / Guardian Name<span
                                                            class="text-red-500">*</span></label>
                                                    <input type="text" onkeypress="return ValidateAlpha(event)"
                                                        name="father_name" maxlength="40"
                                                        class="w-full form-control  shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                                                        placeholder="Enter Father / Guardian Name">
                                                    <span id="fatherName-error" class="text-red-500"></span>
                                                </div>
                                                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                                    <label for="firstname" class="form-label">Father / Guardian
                                                        Mobile<span class="text-red-500">*</span></label>
                                                    <input type="tel" onkeypress="return onlyNumberKey(event)"
                                                        name="father_mobile" maxlength="10" minlength="10"
                                                        class="w-full form-control  shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                                                        placeholder="Enter Father / Guardian Mobile">
                                                    <span id="fatherMobile-error" class="text-red-500"></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="border-b-2 pt-0">
                                            ...
                                            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                                                <div class="flex-1 w-3/5">
                                                    ...
                                                    <div data-step="2">
                                                        <div class="text-lg font-bold text-gray-700 leading-tight"
                                                        style="display:none">Personal Information
                                                            </div>
                                                    </div>
                                                    <div data-step="3">
                                                        <div class="text-lg font-bold text-gray-700 leading-tight"
                                        ...
                                        <div class="mb-5">
                                            <div class="grid grid-cols-12 gap-2 mt-0">
                                                ...
                                                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                                    ...
                                                    <textarea name="address" id="permanentAddress"
                                                        class="w-full form-control shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                                                ...
                                                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                                    ...
                                                    <input type="text" name="city" id="permanentCity"
                                                ...
                                                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                                    ...
                                                    <input type="text" name="district" id="permanentDistrict"
                                                        onkeypress="return ValidateAlpha(event)"
                                                        class="w-full form-control shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                                                ...
                                                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                                    ...
                                                    <input type="text" minlength="6" maxlength="6"
                                                        onkeypress="return onlyNumberKey(event)" name="pincode"
                                                        id="permanentPincode"
                                                        class="w-full form-control shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                                                ...
                                                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                                    ...
                                                    <textarea name="caddress" id="communicationAddress"
                                                        class="w-full form-control shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                                                        placeholder="Enter Your Address"></textarea>
                                                    <span id="caddress-error" class="text-red-500"></span>
                                                </div>
                                                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                                    <label for="firstname" class="form-label">City</label>
                                                    <input type="text" name="ccity" id="communicationCity"
                                                        onkeypress="return ValidateAlpha(event)"
                                                        class="w-full form-control  shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                                                        placeholder="Enter Your City...">
                                                </div>
                                                ...
                                                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                                    <label for="firstname" class="form-label">District</label>
                                                    <input type="text" name="cdistrict" id="communicationDistrict"
                                                        onkeypress="return ValidateAlpha(event)"
                                                        class="w-full form-control  shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                                                        placeholder="Enter Your District...">
                                                </div>
                                                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                                    <label for="firstname" class="form-label">State</label>
                                                    <select name="cstate" id="cstate"  name="cstate"
                                                        class="form-control">
                                                        <option value="">-- Select State --</option>
                                                        <?php $states = \App\Models\MState::all(); ?>
                                                        @foreach ($states as $state)
                                                ...
                                                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                                    ...
                                                    <input type="text" minlength="6" maxlength="6"
                                                        onkeypress="return onlyNumberKey(event)" name="cpincode"
                                                        id="communicationPincode"
                                                        class="w-full form-control shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                                                        placeholder="Enter Your Pincode">
                                                    <span id="cpincode-error" class="text-red-500"></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="border-t bottom-0 left-0 right-0 py-2 mt-3" id="secondstep">
                                    ...
                                    <div x-show.transition.in="step === 4" data-step="4" id="stepfour">
                                        ...
                                        <div class="mb-5">
                                            <div class="grid grid-cols-12 gap-2 mt-0">
                                                <div class="col-span-12">
                                                    <h2 class="text-xl font-bold text-pending underline">Home
                                                        Association<span class="text-red-500">*</span></h2>
                                                </div>
                                                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                                ...
                                                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                                    <label for="associated_club" class="form-label">Associated Club/District</label>
                                                    <input type="text" onkeypress="return ValidateAlpha(event)"
                                                        name="associated_club"
                                                        class="w-full form-control shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                                                        placeholder="Enter Associated Club">
                                                ...
                                                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                                    <label for="firstname" class="form-label">IFSC Code</label>
                                                        <input type="text" minlength="11" maxlength="11" style="text-transform: uppercase" name="ifsc" class="w-full form-control shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" placeholder="Enter IFSC Code...">
