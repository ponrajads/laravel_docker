...
<div class="content">
    <h2 class="text-xl font-bold truncate text-primary mt-8">
     Coach Details <a class="btn btn-sm btn-pending-soft w-24 float-right" >Go Back</a>
    </h2>
        ...
        <div class="col-span-12 md:col-span-6 2xl:col-span-12">
            ...
            <div class="intro-x">
                <div class="box px-5 py-3 mb-1 flex items-center zoom-in">
                    ...
                    <div class="text-slate-500 playervalue">{{$users->address1}}</div>
                </div>
            </div>
            <div class="intro-x">
                <div class="box px-5 py-3 mb-1 flex items-center zoom-in">
                    ...
                    <div class="text-slate-500 playervalue">{{$users->address2}}</div>
                </div>
            </div>
            <div class="intro-x">
                <div class="box px-5 py-3 mb-1 flex items-center zoom-in">
                    <div class="text-start w-1/4">
                        <div class="font-medium">District
                        </div>
                    </div>
    ...
    <div id="icon-button" class="py-5">
        <div class="preview">
            <div class="flex flex-wrap justify-end">
                <a href="{{route('coach/dashboard')}}" class="btn btn-instagram w-32 mr-2 mb-2"> <i data-lucide="corner-down-left" class="w-4 h-4 mr-2"></i> Back </a>
