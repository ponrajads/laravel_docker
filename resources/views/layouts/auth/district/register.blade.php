...
<script>
    ...
    function checkSecretaryEmailExist() {
    var secretaryEmail = document.getElementById("secretary_email").value;
    $.ajax({
        url: baseUrl + "/getEmailCheck/" + secretaryEmail,
        method: "GET",
        success: function(response) {
            if (response.check == "1" || response.check == 1) {
                document.getElementById("email-error").innerHTML = secretaryEmail + " already exists";
                document.getElementById("secretary_email").value = '';
                $("#secretary_email").css('border-color', 'red');
            } else {
                document.getElementById("email-error").innerHTML = "";
                $("#secretary_email").css('border-color', '');
            }
        }
    });
}
function checkTreasurerEmailExist() {
    var treasurerEmail = document.getElementById("treasurer_email").value;
    $.ajax({
        url: baseUrl + "/getEmailCheck/" + treasurerEmail,
        method: "GET",
        success: function(response) {
            if (response.check == "1" || response.check == 1) {
                document.getElementById("email-error").innerHTML = treasurerEmail + " already exists";
                document.getElementById("treasurer_email").value = '';
                $("#treasurer_email").css('border-color', 'red');
            } else {
                document.getElementById("email-error").innerHTML = "";
                $("#treasurer_email").css('border-color', '');
            }
        }
    });
}
    ...
    const secemail = document.getElementById('secemail').value.trim();
    const resecEmail = document.getElementById('secre-email').value.trim();

if (!secemail) {
    $("#secemail-error").html("Secretary email fields are required.");
    return false;
}
if (!resecEmail) {
    $("#secre-email-error").html("Secretary email fields are required.");
    return false;
}

if (secemail !== resecEmail) {
    $("#secemail-error").html("Secretary emails do not match.");
    $("#secre-email-error").html("Secretary emails do not match.");
    return false;
}

$("#secemail-error").html("");
$("#secre-email-error").html("");
    ...
    function validateStep2() {
        ...
        const treasurerEmail = document.getElementById('treasurer_email').value.trim();
       const reTreasurerEmail = document.getElementById('re-treasurer-email').value.trim();

if (!treasurerEmail) {
    $("#treasurer-email-error").html("Treasurer email fields are required.");
    return false;
}
if (!reTreasurerEmail) {
    $("#re-treasurer-email-error").html("Treasurer email fields are required.");
    return false;
}

if (treasurerEmail !== reTreasurerEmail) {
    $("#treasurer-email-error").html("Treasurer emails do not match.");
    $("#re-treasurer-email-error").html("Treasurer emails do not match.");
    return false;
}

$("#treasurer-email-error").html("");
$("#re-treasurer-email-error").html("");


        const address1 = document.querySelector('input[name="register_address1"]').value.trim();
    if (!address1) {
    ...
    const treasurer_name = document.querySelector('input[name="treasurer_name"]').value.trim();
    if (!treasurer_name) {
        $("#club-error").html("Treasurer Name  is required.");
        return false;
    } else {
        $("#club-error").html("");
    }
	...
	function validateStep3() {
		...
		const photograph = document.querySelector('input[name="association_logo"]').value.trim();
    if (!photograph) {
        $("#association-error").html("Association Logo is required.");
        return false;
    }else{
		$("#association-error").html("");
	}
    const aadhar = document.querySelector('input[name="certificate_state"]').value.trim();
    if (!aadhar) {
        $("#certificate-error").html("Affiliation Certificate is required.");
        return false;
    }else{
...
<script>
	...
	<script>
    // JavaScript function to preview the selected image for DOB Proof
    function previewDOBImage(input) {
        const dobImagePreview = document.getElementById('dobImagePreview');
        const file = input.files[0];
        ...
        if (file) {
            ...
            reader.onload = function(e) {
                // Set the source of the DOB Image preview to the selected image
                dobImagePreview.src = e.target.result;
            };
...
<script>
    // JavaScript function to preview the selected image for Address Proof
    function previewAddressProofImage(input) {
        const addressProofImagePreview = document.getElementById('addressProofImagePreview');
        const file = input.files[0];
        ...
        if (file) {
            ...
            reader.onload = function(e) {
                // Set the source of the Address Proof Image preview to the selected image
                addressProofImagePreview.src = e.target.result;
            };
...
<script>
    function previewaadharImage(input) {
        const dobImagePreview = document.getElementById('aadharImagePreview');
        const file = input.files[0];
