...
<script>
    ...
    function validateStep1() {
        ...
        const association = document.querySelector('input[name="association"]').value.trim();
        if (!association) {
            $("#association-error").html("association is required.");
            return false;
        }else{
...
function toggleOtherQualificationInput() {
        ...
        var natQualification = document.getElementById('nationals_qualification');
        var interQualification = document.getElementById('international_qualification');

        if(qualificationSelect.value == 'International'){
            interQualification.style.display = 'block';
        }else{
            interQualification.style.display = 'none';
            document.getElementById('international_qualification').value = '';
        }
        if(qualificationSelect.value == 'Nationals'){
            natQualification.style.display = 'block';
        }else{
            natQualification.style.display = 'none';
            document.getElementById('nationals_qualification').value = '';
        }
