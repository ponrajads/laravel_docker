...
<div class="content">
    <h2 class="text-xl font-bold truncate text-primary mt-8">
        List of Approved Players <a class="btn btn-sm btn-pending-soft w-24 float-right" href="{{route('state/dashboard')}}">Back to Home</a>
    </h2>
                    ...
                    <tr class="intro-x">
                        ...
                        <td class="table-report__action">
                            <div class="flex justify-center items-center">
                                <a class="flex items-center mr-2 text-xs" href="{{route('state/player', $players->user_id)}}"> <i data-lucide="eye" class="w-3 h-3 mr-1"></i> View </a>
