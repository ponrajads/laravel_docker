        ...
        <div class="col-span-12 md:col-span-6 2xl:col-span-12">
            <div class="intro-x">
                <div class="box px-5 py-3 mb-0 flex items-center zoom-in">
                    ...
                    <div class="text-slate-500 playervalue">@if($user->dob != ''){{date("d-m-Y",strtotime($user->dob))}}@endif</div>
                </div>
            </div>
        </div>
        <div class="col-span-12 md:col-span-6 2xl:col-span-12">
...
<script>
     ...
     function approveUser(userId) {
        ...
        $.ajax({
            url: baseUrl + "/state/coach/approve/" + userId,
            type: 'GET',
    ...
    function rejectUser(userId) {
        ...
        // Make AJAX request
        $.ajax({
            url: baseUrl + "/state/coach/reject/"+userId+"/"+selectedReason, // Replace with your actual route
            type: 'GET',
            success: function(response) {
                // Handle success response
                console.log(response);
...
<script>
    function blockUser(userId) {
        ...
        // Make AJAX request
        $.ajax({
            url: baseUrl + "/state/coach/block/"+userId, // Replace with your actual route
            type: 'GET',
            success: function(response) {
                // Handle success response
                console.log(response);
